...
| ----------------------------- | ------------------------------------------------- | ---------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------- |
| Profile                       | Profile Info / Working Hours                      | ▫️         | Define save vs. auto-save, tutorial overlay                      | Cache profile + working hours with auto background refetch (focus + 90s polling)              | In Progress | Should organization admins be allowed to change staff working hours directly, or must owners confirm adjustments?          |
| General                       | Branding / Social / Regional                      | ▫️         | Explicit save w/ footer + inline upload                          | Cached, background refetch (focus + 90s polling) keeps tabs in sync                           | In Progress | Do we enforce brand color/logo constraints aligned with marketing guidelines or permit unrestricted customization?         |
