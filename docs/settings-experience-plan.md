...
| Leads                         | Statuses / Fields                                 | ✅         | Drag reorder + dialog pattern                                    | ✅ Normalized queries + reduced background polling via shared caches                           | In Progress | What default pipeline stages must every workspace retain, and can teams delete core stages?                                |
