...
| 64 | jest | `src/components/data-table/__tests__/AdvancedDataTable.test.tsx` | ⚠️ Skipped | Entire suite marked with `describe.skip`; investigate enabling tests. |
...
| 78 | jest | `src/components/settings/__tests__/ServiceDialogs.test.tsx` | ⚠️ Skipped | Entire suite wrapped in `describe.skip`; enable tests before recording pass. |
