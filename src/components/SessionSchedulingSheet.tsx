...
export function SessionSchedulingSheet({
  ...
  // Auto-generated session name for comparison
  const autoGeneratedName = `${leadName} Session`;
  
  // Compute dirty state for guard (exclude auto-generated session name from dirty check)
  const dirtyForGuard = 
    (formData.session_name !== autoGeneratedName && formData.session_name.trim() !== '') ||
