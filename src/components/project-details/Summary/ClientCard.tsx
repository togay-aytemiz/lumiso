...
export default function ClientCard({
  ...
  return <Card className="rounded-2xl border bg-white shadow-sm">
      ...
      <CardContent className="p-4 pt-0">
        <ClientDetailsList name={name} email={email} phone={phone} notes={notes} clickableNameHref={`/leads/${leadId}`} clickableNameClasses="text-blue-600 hover:text-blue-800 hover:underline" showQuickActions clampNotes />
      </CardContent>
    </Card>;
}