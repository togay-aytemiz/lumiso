...
const TooltipContentDark = React.forwardRef<
  React.ElementRef<typeof TooltipPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof TooltipPrimitive.Content>
>(({ className, ...props }, ref) => (
  <TooltipContent
    ref={ref}
    className={cn("max-w-[260px] bg-slate-900 text-slate-50 border-slate-800", className)}
    {...props}
  />
))
TooltipContentDark.displayName = "TooltipContentDark"

export { Tooltip, TooltipTrigger, TooltipContent, TooltipContentDark, TooltipProvider }
