-- Create organization and membership for the user who doesn't have any
DO $$
DECLARE
...
BEGIN
    ...
    INSERT INTO organization_members (organization_id, user_id, system_role, status)
    VALUES (org_id, user_uuid, 'Owner', 'active')
