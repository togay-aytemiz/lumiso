...
CREATE INDEX IF NOT EXISTS idx_user_settings_user_active_org 
...
CREATE INDEX IF NOT EXISTS idx_project_types_org_sort 
ON public.project_types(organization_id, sort_order, is_default);

CREATE INDEX IF NOT EXISTS idx_lead_statuses_org_sort 
