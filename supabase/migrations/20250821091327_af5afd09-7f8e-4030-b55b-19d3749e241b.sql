-- Add step tracking columns to user_settings table
ALTER TABLE public.user_settings 
ADD COLUMN IF NOT EXISTS current_step integer DEFAULT 1,
ADD COLUMN IF NOT EXISTS completed_steps jsonb DEFAULT '[]'::jsonb;

-- Create function to advance guided step
...
-- Create function to set guided step (for developer tools)
...
-- Create function to reset guided setup
