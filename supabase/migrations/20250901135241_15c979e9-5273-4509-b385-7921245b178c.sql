-- Fix the HTTP post function calls in trigger functions
-- Use the correct net.http_post function from pg_net extension
...
BEGIN
  ...
  LOOP
    ...
    IF notification_record.notification_global_enabled = true 
      ...
      -- Call the edge function directly for immediate delivery using correct pg_net function
      SELECT extensions.net.http_post(
        'https://rifdykpdubrowzbylffe.supabase.co/functions/v1/send-reminder-notifications',
        jsonb_build_object(
          'type', 'new-assignment',
          'entity_type', 'lead',
        ...
        '{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJpZmR5a3BkdWJyb3d6YnlsZmZlIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1Mzc5Nzk0MywiZXhwIjoyMDY5MzczOTQzfQ.a8z_bUe1HW_SBGWxQqFTy3RWLPh2kNvFSRHgxC0l7lY"}'::jsonb
