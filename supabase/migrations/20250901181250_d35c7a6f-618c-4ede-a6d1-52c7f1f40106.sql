-- Update function to always send milestone notifications (don't exclude the user who made the change)
...
BEGIN
  ...
  IF (old_lifecycle IS DISTINCT FROM new_lifecycle) AND 
    ...
    -- Create notification logs for ALL assignees (including the user who made the change)
    -- Milestone notifications are important for everyone to know about
