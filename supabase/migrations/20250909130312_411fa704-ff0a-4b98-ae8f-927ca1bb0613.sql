...
-- Add unique constraint to session_statuses table first
ALTER TABLE public.session_statuses 
ADD CONSTRAINT session_statuses_name_org_unique 
UNIQUE (name, organization_id);

-- Now add the foreign key constraint to validate session status exists in session_statuses table
