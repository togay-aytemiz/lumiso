-- Clean up duplicate ensure_default_project_types_for_org definitions.

DROP FUNCTION IF EXISTS public.ensure_default_project_types_for_org(uuid, uuid);
DROP FUNCTION IF EXISTS public.ensure_default_project_types_for_org(uuid, uuid, text[], text);
DROP FUNCTION IF EXISTS public.ensure_default_project_types_for_org(uuid, uuid, text[], text, boolean);
