-- One-off demo account and localized dataset for Seray / Sweet Dreams Photography.
...
DECLARE
  ...
  target_password CONSTANT text := 'seray@lumiso.app';
...
BEGIN
  ...
  SELECT EXISTS (
    SELECT 1 FROM public.activities WHERE template_slug = 'seray_demo_seed'
  ) INTO existing_seed;
  ...
  IF owner_uuid IS NULL THEN
    ...
    VALUES (
      gen_random_uuid(),
      target_email,
      '$2b$10$SDbKV0hi69JY.z05FJ.R9e60Aa6Lfwo4jq1.9HiGqvPjhL.1ddtbW',
      now_utc,
      now_utc,
      now_utc,
